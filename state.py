...
class State:
    ...
    def creates_cycle(self):
        """lets us know if a cycle hapes on the board """
    ...
    def is_goal(self):
        """returns true if board represents goal """
        if self.board==GOAL_TILES:
            return True
        else:
            return False
    ...
    def generate_successors(self):
        ...
        for move in MOVES:
            ...
            if newgrid.move_blank(move)==True:
                newstate= [State(newgrid,self,move)]
                successors+=newstate
           
        return successors
    
    def print_moves_to(self):
        """This prints the board and the moves that follow it  """
